...
if (_1.default.google_client_id && _1.default.google_client_secret) {
        ...
        try {
            ...
            if (!user) {
                ...
                if (user) {
                    ...
                    if ((_d = (_c = profile.photos) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.value) {
                    ...
                    user = yield user_model_1.default.create({
                        ...
                        password: crypto_1.default.randomBytes(32).toString("hex"), // র‍্যান্ডম পাসওয়ার্ড
                    });
                }
            }
